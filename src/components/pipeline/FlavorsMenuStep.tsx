...
export const FlavorsMenuStep: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* FOOD PRODUCT CARDS - FULL UNCONSTRAINED VERTICAL SCROLL */}
      <div className="w-full flex-1 overflow-y-auto min-h-0 grid grid-cols-1 md:grid-cols-2 gap-3 pr-1 pb-4">
